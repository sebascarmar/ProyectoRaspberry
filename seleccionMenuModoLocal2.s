...
seleccionMenuModoLocal:
    PUSH {R7, LR}          // Apila reg. en el stack
...
//        CMP   R4, #'\0' 
//        MOVNE   R7, #4      // 4 es el código de la llamada a 'write' del sistema.
//        MOVNE   R0, #1      // Descriptor de archivo de stdout (monitor).
//        LDRNE   R1, =seleccion // Buffer de salida
//        MOVNE   R2, #1    // Cantidad de char a escribir.
//        SWINE   0           // Llamada al sistema para arm 32-bit/EABI.
...
//        SWI   0           // Llamada al sistema para arm 32-bit/EABI.
    ...
    break:
        POP   {R7, LR}        // Desapila reg. del stack.
        MOV   PC, LR
